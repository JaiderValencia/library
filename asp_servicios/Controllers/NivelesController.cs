...
namespace asp_servicios.Controllers
{
    ...
    {
        private INivelesAplicacion? iNivelesAplicacion = null;
        private TokenController? tokenController = null;

        public NivelesController(INivelesAplicacion? iAplicacion,
            TokenController tokenController)
        {
            this.iNivelesAplicacion = iAplicacion;
            this.tokenController = tokenController;
            tokenController!.ponerAccesoId(4);
        }
        ...
        public string Listar()
        {
            ...
            try
            {
                ...
                respuesta["Entidades"] = this.iNivelesAplicacion!.Listar();
        ...
        public string Borrar()
        {
            ...
            try
            {
                ...
                var entidad = this.iNivelesAplicacion!.Borrar(Convert.ToInt32(datos["id"]));
