...
namespace lib_presentaciones.Implementaciones
{
    public class EstanteriasPresentacion : IEstanteriasPresentacion
    {
        ...
        {
            var datos = new Dictionary<string, object> { { "id", Id } };
        ...
        {
            var datos = new Dictionary<string, object> { { "nombre", nombre } };
        ...
        {
            var datos = new Dictionary<string, object> { { "entidad", JsonConversor.ConvertirAString(entidad) } };
